...
- M1 Foundation / State：**完成**
- M2 Field / World / Opening：**完成**
- M3 Battle / RPG Systems：**下一步**

M2 已建立溪石村可走場景、尤哈尼送飯與逆流水渠、正常／慌亂冠耳獸的場上行為對照、珊妮溪流驗證、兄妹會合、領隊教學與回村報告。兩場戰鬥目前使用明確標記的 M2 integration stub，只用來驗證事件圖；正式 party-wide round battle 由 M3 取代。逆流在開場報告後仍持續，必須等後續星標穩定事件才解除。

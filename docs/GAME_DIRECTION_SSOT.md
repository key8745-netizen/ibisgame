...
- Sani pre-convergence combat scope: **no formal battle** — Sani's short solo playable segment focuses on exploration, investigation and her distinct clue; her first formal battle occurs only after sibling convergence.
